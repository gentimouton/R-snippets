# Author: Dan Gillen, UCI
## The original codes for this analysis were written by Gelman and Hill. 
## I have modified the codes for Stat211. 
...
for(i in 2:nIterations) {
    ...
    # Calculating mu_n and sigma2_n: these formulas are the same as what we saw 
	# for simple normal model with conjugate prior and known variance.
    ...
    # I sample a new value for sigma2 from Inv-chi2(mu_n, sigma02_n), 
	# to do this, I sample from z ~ chi2(nu_n) and then my sample 
	# from Inv-chi2 would be nu_n*sigma02_n/z.
	z = rchisq(1, nu_n);
